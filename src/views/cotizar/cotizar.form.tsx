        ...
        >
          	{({ errors, touched }) => (
            	<Form>
					...
					<div className="checkbox-container">
						<Field className="bg-black-main" type="checkbox" id="checkComunication" name="checkComunication"/>
					...
					<button type='submit' className={`bg-black-main rounded-[40px] text-white w-full h-[56px]
